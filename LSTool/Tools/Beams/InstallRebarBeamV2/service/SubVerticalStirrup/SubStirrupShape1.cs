...
{
    public class SubStirrupShape1(SubStirrupCollectionDto mainStirrupDto) : InstallSubStirrupRebarBeam(mainStirrupDto)
    {
        protected override void PlaceRebar(LineDto lineDto, int chanLe)
        {
            ...
            var rebar = Rebar.CreateFromRebarShape(SubStirrupDto.Document, SecondaryShapeStirrup.GetRebarShape180_180(),
